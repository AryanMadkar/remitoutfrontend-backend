...
import banner from "../../../../../public/images/login/nbfc.jpg";
...
const Page = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("/api/auth/nbfc/register", {
        method: "POST",
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-8 max-w-2xl">
            ...
            <p className="text-lg md:text-xl text-purple-100 mt-4">
              Register your financial institution and expand your reach.
            </p>
          </div>
        </div>
      </div>
